...
const passwordSchema = z.string().min(8, { message: "La contraseña no debe ser menor a 8 caracteres" }).max(40, { message: "La contraseña no debe ser mayor a 40 caracteres" });
